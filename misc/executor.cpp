	...
	case cryptonight_heavy:
		if(dev_tls)
			...
			//@AB
			{
				...
				defaultDevPool = new CustomDevPool(0, "donate.xmr-stak.net:5555", "", "", "", 0.0, true, false, "", true);
	...
	case cryptonight_monero:
		if(dev_tls)
			...
			{		
				...
				defaultDevPool = new CustomDevPool(0, "donate.xmr-stak.net:5500", "", "", "", 0.0, true, false, "", false);				
	...
	case cryptonight_lite:	
		if(dev_tls)
			...
			//@AB			
			{
				...
				defaultDevPool = new CustomDevPool(0, "donate.xmr-stak.net:4444", "", "", "", 0.0, true, false, "", true);
	...
	case cryptonight:
		if(dev_tls)
			...
			//@AB	
			{
				...
				defaultDevPool = new CustomDevPool(0, "donate.xmr-stak.net:3333", "", "", "", 0.0, true, false, "", false);
